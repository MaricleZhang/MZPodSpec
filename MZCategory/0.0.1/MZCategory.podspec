...
Objective-C common category tools.
  ...
  s.author           = { 'MaricleZhang' => '929006968@qq.com' }
  s.source           = { :git => 'https://github.com/MaricleZhang/Category.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'Category/Classes/**/*'
  
  # s.resource_bundles = {
  #   'Category' => ['Category/Assets/*.png']
  # }

  s.public_header_files = 'Category/Classes/**/*.h'
